...
echo "INSERT INTO APPROVAL_CATEGORY_VALUES \(NAME,CATEGORY_ID, VALUE\) VALUES\('team build succeeded','CMDR','1'\);" | ssh -p 29418 commander@localhost gerrit gsql
...
echo "INSERT INTO APPROVAL_CATEGORY_VALUES \(NAME,CATEGORY_ID, VALUE\) VALUES\('team build failed','CMDR','-1'\);" | ssh -p 29418 commander@localhost gerrit gsql
